    ...
    private class LabelWindow extends Window
    {
        ...
        public void setLocation(int x, int y)
        {
            ...
            if (pLoc.getX() + pSize.getX() / 2 + getImage().getWidth() <= getWorld().getWidth())
                super.setLocation((int)(pLoc.getX() + pSize.getX() / 2) + getImage().getWidth() / 2, (int)pLoc.getY());
            else if (pLoc.getY() + pSize.getY() / 2 + getImage().getHeight() > getWorld().getHeight())
                super.setLocation(getWorld().getWidth() - getImage().getWidth() / 2, (int)(pLoc.getY() - pSize.getY() / 2) - getImage().getHeight() / 2);
            else
                super.setLocation(getWorld().getWidth() - getImage().getWidth() / 2, (int)(pLoc.getY() + pSize.getY() / 2) + getImage().getHeight() / 2);
        }
    }
